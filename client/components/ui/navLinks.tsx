...
const links = [
    { name: 'Home', href: '/', icon: FaRegCirclePlay },
    { name: 'Posts', href: '/blog/posts', icon: FaTrashCan },
    { name: 'About', href: '/blog/about', icon: FaPenToSquare },
    { name: 'Contact', href: '/blog/contact', icon: FaGear },
];
